...
class Ui_Welcome(object):
    ...
    def retranslateUi(self, Welcome):
        ...
        self.label.setText(_translate("Welcome", "Welcome, please insert the edu email given to you"))
        self.label_3.setText(_translate("Welcome", "Email :"))
        self.quitButton.setText(_translate("Welcome", "Quit"))
        self.weclomNextButton.setText(_translate("Welcome", "Next"))

    def popupWin(self):
        msgBox = QMessageBox()
        msgBox.setText("Are you shure the email is correct?")
        msgBox.setWindowTitle("Check Agian")
        msgBox.setStandardButtons(QMessageBox.StandardButton.Ok | QMessageBox.StandardButton.Cancel)
        
        returnValue = msgBox.exec()
        if returnValue == QMessageBox.StandardButton.Ok:
            if Helper.checkEmail(email=self.emailField.text()):
                self.kfi.setEmail(email=self.emailField.text())
                Welcome.close()
                self.startQ()
            else:
                Helper.popupWinError(msg="Not a valid Email")
